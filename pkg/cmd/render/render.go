...
func (t *TemplateData) setComputedEnvVars(platform, platformData string, installConfig map[string]interface{}) error {
	envVarData := &envVarData{platform: platform, platformData: platformData, arch: runtime.GOARCH, installConfig: installConfig, hostname: t.Hostname, inPlaceBootstrap: t.BootstrapScalingStrategy == ceohelpers.BootstrapInPlaceStrategy}
